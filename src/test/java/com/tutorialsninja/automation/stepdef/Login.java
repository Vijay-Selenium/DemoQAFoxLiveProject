...
public class Login {
	...
	public void i_should_see_an_error_message_informing_the_User_about_invalid_credentials()  {
		...
		Assert.assertTrue(Elements.isDisplayed(LoginPage.invalidLoginWarning));
	}
	...
	public void i_reset_the_forgotten_password_for(String email)  {
		...
		Elements.TypeText(ForgotPasswordPage.forgotEmailAddress, email);
		Elements.click(ForgotPasswordPage.forgotContinueButton);
	}
	...
	public void i_should_see_a_message_informing_that_the_password_reset_details_have_been_sent_to_the_email_address()  {
		...
		Assert.assertTrue(Elements.isDisplayed(ForgotPasswordPage.passwordResetMessage));
	}
}
